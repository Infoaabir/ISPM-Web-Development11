...
//'$('.top_mnavi a').filter(function(){return $(this).attr('href') == filename }).closest('ul').parent().addClass('active');
//$('.top_mnavi a[href$="' + filename + '"]').parent('li').addClass("active");
//$('.topnav a[href$="' + filename + '"]').parent().addClass("active");
$('.nav-vertical a[href$="' + filename + '"]').parent().addClass("active");
...
{
  document.getElementById('hanm1').style.display = 'none';
  document.getElementById('hanm2').style.display = 'block';
}else{
	document.getElementById('hanm2').style.display = 'none';
